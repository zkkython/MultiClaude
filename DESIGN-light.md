# Design System: MultiClaude Control Room (Light)

## 1. Visual Theme & Atmosphere
MultiClaude in light mode should feel like a precision studio console: clear, methodical, and calm under high information load.  
...
Use bright neutral surfaces, disciplined contrast, and mono-aligned data rhythm so users can manage many terminals without visual noise.

## 2. Color Palette & Roles
- **Studio Canvas** (`#F4F6F8`) - Global app background.
- **Panel White** (`#FFFFFF`) - Primary panel and modal surfaces.
- **Soft Zinc** (`#EEF1F4`) - Secondary strips, tabs background, grouped rows.
- **Divider Steel** (`#D8DEE6`) - Structural borders and separators (1px).
- **Primary Ink** (`#1A2330`) - Main text and high-priority labels.
- **Secondary Ink** (`#4E5A6C`) - Metadata, helper text, quiet labels.
- **Muted Ink** (`#7B8798`) - Disabled states and tertiary annotations.
- **Signal Amber** (`#B8872F`) - Single accent for primary CTA, focus ring, active indicator.
- **State Success** (`#3E9A66`) - Success and healthy runtime state.
- **State Warning** (`#B8872F`) - Caution and preflight warnings.
- **State Error** (`#B44E4E`) - Error and destructive actions.

Rules:
- Max one accent color for interaction emphasis: `#B8872F`.
